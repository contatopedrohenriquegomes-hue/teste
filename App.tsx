    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden selection:bg-yellow-500 selection:text-black">
      ...
      <header className="relative pt-20 pb-10 px-4 flex flex-col items-center text-center">
        <ScrollReveal>
          <h1 className="text-white text-3xl md:text-6xl lg:text-7xl font-black max-w-5xl mb-12 tracking-tighter uppercase leading-[0.9]">
            ...
            <span className="text-yellow-430">maior</span> <span className="text-yellow-400">Banco de Vídeos</span> <br />
            <span className="text-yellow-430">Lifestyle Gringo!</span>
          </h1>
        </ScrollReveal>
      ...
      <section className="py-16 flex flex-col items-center text-center px-4">
        <ScrollReveal>
          ...
          <button className="bg-gold-gradient text-black font-black text-xl md:text-2xl py-4 px-12 rounded-full shadow-[0_0_25px_rgba(255,215,0,0.6)] hover:scale-105 active:scale-95 transition-all uppercase tracking-tighter">
            QUERO APROVEITAR!
          </button>
        </ScrollReveal>
      </section>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-black to-zinc-950">
        <ScrollReveal className="max-w-3xl mx-auto text-center mb-16">
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            <button className="bg-white text-black font-black text-xl md:text-2xl py-3 px-10 rounded-full hover:bg-yellow-400 transition-colors uppercase tracking-tight shadow-xl">
              CLIQUE AQUI!
            </button>
            <button className="text-zinc-500 text-[10px] md:text-xs font-bold uppercase tracking-widest hover:text-white transition-colors">
        ...
        <ScrollReveal>
          <div className="bg-black border-2 border-yellow-500 rounded-2xl p-6 md:p-8 shadow-[0_0_50px_rgba(255,215,0,0.3)] flex flex-col items-center">
            ...
            <div className="text-center w-full">
              ...
              <button className="w-full bg-gold-gradient text-black font-black text-lg py-3 rounded-xl shadow-lg hover:brightness-110 transition-all uppercase mb-2">
                QUERO APROVEITAR!
              </button>
